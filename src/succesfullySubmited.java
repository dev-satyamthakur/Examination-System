...
public class succesfullySubmited extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(535, 369, -1, -1));

        jLabel2.setFont(new java.awt.Font("Arial Narrow", 1, 60)); // NOI18N
        jLabel2.setText("Successfully updated");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(516, 457, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(succesfullySubmited.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new succesfullySubmited().setVisible(true);
            }
        });
    }
