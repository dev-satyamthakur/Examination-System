...
public class allResultStudent extends javax.swing.JFrame {

    /**
     * Creates new form allResultStudent
     */
    public allResultStudent() {
        initComponents();
        try{
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, 79, 1070, 10));
        ...
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(268, 107, 139, -1));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 158, 1054, 371));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(allResultStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
